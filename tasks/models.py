...
class UserSettings(models.Model):
    ...
    timezone = models.CharField(
        max_length=100, choices=TIMEZONE_CHOICES, default=settings.TIME_ZONE
    )
    report_time = models.DateTimeField(default=localtime)
    ...
    def save(self, *args, **kwargs):
        if self.send_report:
            ...
            if (
                ...
                self.last_report_sent_at = self.report_time - timedelta(days=1)
            else:
                self.last_report_sent_at = self.report_time
        super().save(*args, **kwargs)
